...
- Name: landing.spec.ts >> Auth redirects >> unauthenticated /history redirects to /
- Location: e2e/landing.spec.ts:59:7
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    2 × unexpected value "http://localhost:3000/history"
