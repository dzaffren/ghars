...
// Exported only for debug scripts — do not use in route handlers or components.
export const ensureContentTokenForDebug = ensureContentToken;
...
// Reflect gateway (apis.quran.foundation/quran-reflect) requires post.read scope —
// separate from the content scope used by api.quran.com/api/v4.
