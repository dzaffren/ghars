  ...
  return (
    ...
    >
      ...
      <motion.div variants={item} className="space-y-3">
        ...
        <a
          href="/api/auth/start"
          className="flex items-center justify-center w-full rounded-xl py-3.5 px-6 text-sm font-semibold border transition-all duration-200 hover:bg-[#2d6a4f]/5 active:scale-[0.98]"
